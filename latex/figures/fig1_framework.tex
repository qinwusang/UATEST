...
\caption{Imperfect-CSI SwinJSCC framework. The true SNR $\gamma$ determines the physical AWGN corruption, while the estimated SNR $\hat{\gamma}$ conditions the Channel ModNet branches in the encoder and decoder.}
\label{fig:framework}
\end{figure}
